...
const AboutUs = () => {
  return (
    <div className="w-full rounded-md bg-neutral-950 relative overflow-hidden flex flex-col items-center justify-center antialiased mt-20">
      <div className="max-w-7xl mx-auto pt-12">
        <h2 className="relative z-10 text-2xl mb-6 md:text-7xl  bg-clip-text text-transparent bg-gradient-to-b from-neutral-100 to-neutral-300  text-center font-sans font-bold">
          about tapped ai
        </h2>
        ...
        <h2 className="relative z-10 text-2xl mb-6 md:text-7xl pt-10  bg-clip-text text-transparent bg-gradient-to-b from-neutral-100 to-neutral-300  text-center font-sans font-bold">
          our approach
        </h2>
        <p className="text-neutral-400 max-w-xl mx-auto my-4 text-sm text-center relative z-10 p-4">
